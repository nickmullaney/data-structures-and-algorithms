...
const toLastNames = people => {
  return people.map(newName => newName.firstName + " " + newName.lastName);
};
...
const addPurchases = (arr) => {
  return arr.reduce((item, purchase) => item + purchase.purchasePrice, 0);
};
